...
import { ConveyLinx_FullPLC_Single_Mini } from 'plc/PLC_MAIN';
import {
	ComponentIdService,
...
@Component({
	selector: 'app-convey-linx-mini-PLC-single-motor',
	templateUrl: './convey-linx-mini-PLC-single-motor.component.html',
	styleUrls: ['./convey-linx-mini-PLC-single-motor.component.scss']
})
export class ConveyLinxMiniPLCSingleMotorComponent extends MotorBaseControl
	implements OnInit, OnDestroy {
	_tag: ConveyLinx_FullPLC_Single_Mini;
